...
import br.com.study.view.FacesUtil;


/**
 * PhaseListener utilizado para capturar exce��es de autentica��o
 *
 */
...
public class LoginErrorPhaseListener implements PhaseListener {
	...
	public void beforePhase(PhaseEvent arg0) {
		...
		if(dadosIncorretosException instanceof BadCredentialsException) {
			...
			FacesUtil.exibirMensagemErro("Dados incorretos, tente novamente!");
		}
	}
